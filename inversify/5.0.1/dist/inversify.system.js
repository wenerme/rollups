System.register([], function (exports) {
    ...
    return {
        execute: function () {
            ...
            var BindingScopeEnum = exports('BindingScopeEnum', {
                Request: "Request",
                Singleton: "Singleton",
                Transient: "Transient"
            });
            var BindingTypeEnum = exports('BindingTypeEnum', {
            ...
            var TargetTypeEnum = exports('TargetTypeEnum', {
            ...
            var MetadataReader = exports('MetadataReader', (function () {
            ...
            var LazyServiceIdentifer = exports('LazyServiceIdentifer', (function () {
            ...
            var traverseAncerstors = exports('traverseAncerstors', function (request, constraint) {
            ...
            var taggedConstraint = exports('taggedConstraint', function (key) { return function (value) {
            ...
            var namedConstraint = exports('namedConstraint', taggedConstraint(NAMED_TAG));
            var typeConstraint = exports('typeConstraint', function (type) { return function (request) {
                var binding = null;
                if (request !== null) {
            ...
            var ContainerModule = exports('ContainerModule', (function () {
            ...
            var AsyncContainerModule = exports('AsyncContainerModule', (function () {
            ...
            var multiBindToService = exports('multiBindToService', function (container) {
            ...
            var METADATA_KEY = exports('METADATA_KEY', keys);

        }
    };
});
//# sourceMappingURL=inversify.system.js.map
